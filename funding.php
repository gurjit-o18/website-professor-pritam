...
<section class="page-header">
    <div class="container">
        <h1><i class="fas fa-hand-holding-usd me-3"></i>Funding</h1>
    </div>
</section>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="text-primary mb-1"><strong><i class="fas fa-landmark me-1"></i><?= h($item['funder']) ?></strong></p>
                        <?php if (!empty($item['notes'])): ?>
                        <p class="text-muted small mb-0"><?= h($item['notes']) ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="text-end ms-3">
                        <span class="badge bg-success d-block mb-1"><i class="fas fa-pound-sign me-1"></i><?= h($item['amount']) ?></span>
