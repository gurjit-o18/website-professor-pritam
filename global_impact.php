...
<section class="page-header">
    <div class="container">
        <h1><i class="fas fa-globe-americas me-3"></i>Global Impact</h1>
    </div>
</section>

<main class="container my-5">
    <?php if (!empty($visiting)): ?>
    <h2 class="mt-4 mb-3"><i class="fas fa-plane me-2 text-primary"></i>Visiting Positions</h2>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <p class="text-muted mb-0"><i class="fas fa-university me-1"></i><?= h($item['institution']) ?></p>
    ...
    <h2 class="mt-4 mb-3"><i class="fas fa-calendar-alt me-2 text-primary"></i>International Conferences Organised</h2>
    ...
    <h2 class="mt-4 mb-3"><i class="fas fa-language me-2 text-primary"></i>Translations of Work</h2>
    ...
    <?php if (!empty($panels)): ?>
    <h2 class="mt-4 mb-3"><i class="fas fa-users me-2 text-primary"></i>Panels Chaired</h2>
    <div class="card">
        <div class="card-body">
